...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.instance-1', { style: 'blur-in', speed: 875, intensity: 3, threshold: 3, delay: 125, stagger: 125, staggerSelector: ':scope > *', state: true, replay: false });
		onvisible.add('.divider-component.instance-1', { style: 'fade-in', speed: 1000, intensity: 10, threshold: 3, delay: 500, state: true, replay: false });
		onvisible.add('.icons-component.instance-1', { style: 'blur-in', speed: 1000, intensity: 3, threshold: 3, delay: 250, stagger: 125, staggerOrder: 'reverse', staggerSelector: ':scope > li', state: true, replay: false });
